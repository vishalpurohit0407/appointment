...
class PatientController extends Controller
{
    ...
    {
        return view('clinic_user.patient.list',array('title' => 'Patient List','breadcrumb' => array()));
    }
    ...
    {
        return view('clinic_user.patient.create', array('title' => 'Create New Patient', 'breadcrumb' => array(
                array('title' => 'Patient List', 'link' => route('patient.list')))));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if($request->file('profile_img')){
                ...
                $path = Common::uploadFile($request->file('profile_img'),'patient_profile',$patient->id);
    ...
    public function show($id)
    {
        ...
        return view('clinic_user.patient.detail',array('title' => 'Patient Details','patientdata'=>$patient, 'breadcrumb' => array(
                array('title' => 'Patient List', 'link' => route('patient.list')),
        )));
    }
    ...
    public function edit($id)
    {
        $decode_id = \Hashids::decode($id);
        $patient = User::where('id',$decode_id)->first();
        return view('clinic_user.patient.edit',array('title' => 'Edit Patient','patientdata'=>$patient, 'breadcrumb' => array(
                array('title' => 'Patient List', 'link' => route('patient.list')))));
    }
        ...
        try {
            ...
            if($request->file('profile_img')){
                ...
                if ($patient->profile_pic) {
                    Common::deleteImage($patient->profile_pic);
                }
                $path = Common::uploadFile($request->file('profile_img'),'patient_profile',$patient->id);
    ...
    public function import(Request $request){
        return view('clinic_user.patient.import',array('title' => 'Import Patient','breadcrumb' => array(array('title' => 'Patient List', 'link' => route('patient.list')))));
