		...
		<div class="card card-custom card-stretch">
			...
			<div class="card-body pt-4">
				...
				<div class="d-flex align-items-center">
					...
					<div>
						<a href="javascript:void(0);" class="font-weight-bolder font-size-h5 text-dark-75 text-hover-primary">{{Auth::user()->name}}</a>
						<div class="text-muted">Clinic User</div>
					</div>
				</div>
				<!--end::User-->
				<!--begin::Contact-->
				<div class="py-9">
					...
					<div class="d-flex align-items-center justify-content-between mb-2">
						<span class="font-weight-bold mr-2">Provider Name:</span>
						<span class="text-muted">{{Auth::user()->provider_name}}</span>
					</div>
					<div class="d-flex align-items-center justify-content-between mb-2">
				...
				<div class="navi navi-bold navi-hover navi-active navi-link-rounded">
					<div class="navi-item mb-2">
						<a href="{{route('editprofile')}}" class="navi-link py-4 {{Request::routeIs('editprofile') ? 'active' : ''}}">
					...
					<div class="navi-item mb-2">
						<a href="{{route('changepass')}}" class="navi-link py-4 {{Request::routeIs('changepass') ? 'active' : ''}}">
							<span class="navi-icon mr-2">
								<span class="svg-icon">
