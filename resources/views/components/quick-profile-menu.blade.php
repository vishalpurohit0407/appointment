      ...
      <div class="offcanvas-content pr-5 mr-n5">
        ...
        <div class="d-flex align-items-center mt-5">
          <div class="symbol symbol-100 mr-5">
            ...
            @else
	        	<span class="symbol-label font-size-h1 font-weight-bold bg-primary-o-30">{{strtoupper(mb_substr(Auth::user()->name, 0, 1))}}</span>
            	<i class="symbol-badge bg-success"></i>
           	@endif
          </div>
          <div class="d-flex flex-column">
            <a href="#" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">{{Auth::user()->name}}</a>
            <div class="text-muted mt-1">Clinic User</div>
            <div class="navi mt-2">
        ...
        <div class="navi navi-spacer-x-0 p-0">
          <!--begin::Item-->
          <a href="{{route('editprofile')}}" class="navi-item">
            <div class="navi-link">
          ...
          <!--end:Item-->
          <!--begin::Item-->
          <a href="{{route('changepass')}}" class="navi-item">
            <div class="navi-link">
              <div class="symbol symbol-40 bg-light mr-3">
                <div class="symbol-label">
