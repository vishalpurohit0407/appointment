      ...
      <div class="offcanvas-content pr-5 mr-n5">
        ...
        <div class="d-flex align-items-center mt-5">
          <div class="symbol symbol-100 mr-5">
            ...
            @else
	        	<span class="symbol-label font-size-h1 font-weight-bold bg-primary-o-30">{{strtoupper(mb_substr(Auth::guard('admin')->user()->name, 0, 1))}}</span>
            	<i class="symbol-badge bg-success"></i>
           	@endif
          </div>
        ...
        <div class="navi navi-spacer-x-0 p-0">
          <!--begin::Item-->
          <a href="{{route('admin.editprofile')}}" class="navi-item">
            <div class="navi-link">
              ...
              <div class="navi-text">
                ...
                <div class="text-muted">Edit personal profile and more
          ...
          <!--end:Item-->
          <!--begin::Item-->
          <a href="{{route('admin.changepass')}}" class="navi-item">
            <div class="navi-link">
              <div class="symbol symbol-40 bg-light mr-3">
                <div class="symbol-label">
          ...
          <a href="{{route('admin.settings')}}" class="navi-item">
            <div class="navi-link">
              ...
              <div class="navi-text">
                ...
                <div class="text-muted">Script sync settings</div>
              </div>
            </div>
          </a>
          <!--end:Item-->
