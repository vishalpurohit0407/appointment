                ...
                <div class="card card-custom card-stretch">
                    ...
                    <div class="card-header py-3">
                        <div class="card-title align-items-start flex-column">
                            <h3 class="card-label font-weight-bolder text-dark"> Import Patient </h3>
                    ...
                    <!--end::Header-->
                    <!--begin::Form-->
                  <form class="form" name="submit"  action="{{ route('admin.patient.importdata') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="custom-file">
                                            <a href="{{asset('assets/sample-csv/sample_patient.csv')}}"><i class="icon-2x text-info flaticon-download-1"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
