        ...
        <div class="card card-custom">
            <div class="card-header">
                ...
                <div class="card-toolbar">
                    <!--begin::Button-->
                    <a href="{{route('admin.patient.create')}}" class="btn btn-primary font-weight-bolder">
                    ...
                    <!--end::Button-->
                    <!--begin::Button-->
                    <a href="{{route('admin.patient.import')}}" class="btn btn-primary font-weight-bolder ml-2">
                    <span class="svg-icon svg-icon-md">
                        <!--begin::Svg Icon | path:/metronic/theme/html/demo7/dist/assets/media/svg/icons/Design/Flatten.svg-->
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        table.DataTable({
            ...
            order: [[ 1, "desc" ]],
            ajax: {
                url: "{{route('admin.patient.listdata')}}",
                type: 'POST',
                data: {
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    orderable: false,
                    render: function(data, type, full, meta) {
                        var urledit = '{{ route("admin.patient.edit",":id") }}';
                        var urlshow= '{{ route("admin.patient.show",":id") }}';
                        var urldelete = '{{ route("admin.patient.destroy",":id") }}';
