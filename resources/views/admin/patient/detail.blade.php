					...
					<div class="flex-grow-1">
						...
						<div class="d-flex align-items-center justify-content-between flex-wrap mt-2">
							...
							<div class="my-lg-0 my-1">
								<a href="{{route('admin.patient.edit',$patientdata->hashid)}}" class="btn btn-sm btn-secondary font-weight-bolder text-uppercase mr-2">Edit</a>
								<a href="{{route('admin.patient.list')}}" class="btn btn-sm btn-primary font-weight-bolder text-uppercase mr-2">Back</a>
							</div>
							...
							<div class="col-lg-12">
								<div class="font-weight-bold text-dark-50 py-2 py-lg-">
									<div class="d-flex align-items-center">
										<span class="text-dark-75 font-weight-bolder mr-4">Patient ID (ERP Patient ID):</span>
										<span class="text-muted">{{$patientdata->erp_id ? $patientdata->erp_id : 'N/A'}}</span>
									</div>
								</div>
							</div>
							<div class="col-lg-12">
