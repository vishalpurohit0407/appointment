...
@section('content')
  ...
  <div class="login-signin">
    ...
    @endif
    <form role="form" method="POST" action="{{ route('admin.login.check') }}">
      @csrf
      <div class="form-group mb-5">
        <input class="form-control h-auto form-control-solid py-4 px-8 @error('username') is-invalid @enderror" type="text" placeholder="Username / Email *" name="username" autocomplete="off"  value="{{ old('username') }}"/>
        @error('username')
