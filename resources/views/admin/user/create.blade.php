        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <div class="card card-custom card-stretch">
                    ...
                    <!--end::Header-->
                    <!--begin::Form-->
                    <form class="form" name="submit"  action="{{ route('admin.user.store') }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <!--Begin::Body-->
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" class="form-control @if($errors->has('provider_name')) is-invalid @endif maxlength" maxlength="255" name="provider_name" placeholder="Provider Name" value="{{old('provider_name')}}">
                                    @error('provider_name')
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" class="form-control @if($errors->has('name')) is-invalid @endif maxlength" maxlength="255" name="name" placeholder="Full Name" value="{{old('name')}}">
                                    @error('name')
                                        <div class="invalid-feedback"><strong>{{ $message }}</strong></div>
                                    @enderror
                                </div>
