				...
				<div class="d-flex">
					...
					<div class="flex-shrink-0 mr-7">
						<div class="symbol symbol-50 symbol-lg-120">
							@if(isset($userdata->profile_pic) && Storage::exists($userdata->profile_pic))
								<img alt="Pic" class="w-100" src="{{Storage::url($userdata->profile_pic)}}">
							@else
					...
					<div class="flex-grow-1">
						...
						<div class="d-flex align-items-center justify-content-between flex-wrap mt-2">
								...
								<div class="d-inline-block my-2">
									<a href="javascript:void(0);" class="text-muted text-hover-primary font-weight-bold mr-lg-8 mr-5 mb-lg-0 mb-2">
										<span class="svg-icon svg-icon-md svg-icon-gray-500 mr-1">
											...
											<!--end::Svg Icon-->
										</span>{{$userdata->email ? $userdata->email : 'N/A'}}</a>
									<a href="javascript:void(0);" class="text-muted text-hover-primary font-weight-bold mr-lg-8 mr-5 mb-lg-0 mb-2">
										<span class="svg-icon svg-icon-md svg-icon-gray-500 mr-1">
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
											    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
										...
										</span>{{$userdata->mobile ? ucfirst($userdata->mobile) : 'N/A'}}
									</a>
									<!-- <a href="javascript:void(0);" class="text-muted text-hover-primary font-weight-bold mr-lg-8 mr-5 mb-lg-0 mb-2">
										<span class="svg-icon svg-icon-md svg-icon-gray-500 mr-1">
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
										...
										</span>{{$userdata->address ? ucfirst($userdata->address) : 'N/A'}}
									</a> -->
								</div>
								<!--end::Contacts-->
							</div>
							...
							<div class="my-lg-0 my-1">
								<a href="{{route('admin.user.edit',$userdata->hashid)}}" class="btn btn-sm btn-secondary font-weight-bolder text-uppercase mr-2">Edit</a>
								<a href="{{route('admin.user.list')}}" class="btn btn-sm btn-primary font-weight-bolder text-uppercase mr-2">Back</a>
							</div>
							...
							<div class="col-lg-6">
								<div class="font-weight-bold text-dark-50 py-2 py-lg-">
									<div class="d-flex align-items-center">
										<span class="text-dark-75 font-weight-bolder mr-4">Provider Name :</span>
										<span class="text-muted">{{$userdata->provider_name ? $userdata->provider_name : 'N/A'}}</span>
									</div>
								</div>
							</div>
							<div class="col-lg-12">
								<div class="font-weight-bold text-dark-50 py-2 py-lg-">
									<div class="d-flex align-items-center">
										<span class="text-dark-75 font-weight-bolder mr-4">Status :</span>
							...
							<div class="col-lg-6">
								<div class="font-weight-bold text-dark-50 py-2 py-lg-">
									<div class="d-flex align-items-center">
										...
										<span class="text-muted">{{$userdata->created_at ? date('jS F Y', strtotime($userdata->created_at)) : 'N/A'}}</span>
									</div>
								</div>
							</div>
							<!--end::Description-->
