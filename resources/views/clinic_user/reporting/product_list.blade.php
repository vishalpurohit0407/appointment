        ...
        <div class="card card-custom">
            <div class="card-header">
                ...
                <div class="card-toolbar">
                    <!--begin::Button-->
                    <a href="{{route('reporting.list')}}" class="btn btn-light-primary font-weight-bolder px-8 font-size-sm">
                    <span class="svg-icon">
...
<script type="text/javascript">
    $(document).ready(function() {
        var table = $('#kt_datatable').DataTable({
            ...
            order: [[ 1, "desc" ]],
            ajax: {
                url: "{{route('reporting.product.list.data')}}",
                type: 'POST',
                data: {
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    orderable: false,
                    render: function(data, type, full, meta) {
                        var urlshow= '{{ route("reporting.product.details",":id") }}';
