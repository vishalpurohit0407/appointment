...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#patient_id").select2({
            ...
            ajax: {
                url: "{{route('reporting.get.patient')}}",
                dataType: 'json',
                delay: 250,
        ...
        var table = $('#kt_datatable').DataTable({
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function(data, type, full, meta) {
                        return '<div class="d-flex align-items-center">\
                                    <div class="ml-3">\
                                        <span class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">'+full.session_id+'</span>\
                                    </div>\
                                </div>';
                    },
                },
                {
                    ...
                    orderable: false,
                    render: function(data, type, full, meta) {
                        var urlproductlist= '{{ route("reporting.product.list",[":id","cust_id","start_date","end_date"]) }}';
                        urlproductlist = urlproductlist.replace(':id', full.session_id);
                        urlproductlist = urlproductlist.replace('cust_id',full.cust_id || null);
