					...
					<div class="flex-grow-1">
						...
						<div class="d-flex align-items-center justify-content-between flex-wrap mt-2">
							...
							<div class="my-lg-0 my-1">
								<a href="{{route('patient.edit',$patientdata->hashid)}}" class="btn btn-sm btn-secondary font-weight-bolder text-uppercase mr-2">Edit</a>
								<a href="{{route('patient.list')}}" class="btn btn-sm btn-primary font-weight-bolder text-uppercase mr-2">Back</a>
							</div>
							...
							<div class="col-lg-12">
								<div class="font-weight-bold text-dark-50 py-2 py-lg-">
									<div class="d-flex align-items-center">
										<span class="text-dark-75 font-weight-bolder mr-4">Name:</span>
								...
								<div class="font-weight-bold text-dark-50 py-2 py-lg-">
									<div class="d-flex align-items-center">
										...
										@if($patientdata->gender == 0)
											...
											<span class="font-weight-bold text-info">Female</span>
										@elseif($patientdata->gender == 1)
											<span class="label label-success label-dot mr-2"></span>
											<span class="font-weight-bold text-success">Male</span>
										@endif
									</div>
								</div>
							</div>
							<div class="col-lg-12">
								<div class="font-weight-bold text-dark-50 py-2 py-lg-">
									<div class="d-flex align-items-center">
										...
										<span class="text-muted">{{$patientdata->dob ? date('jS F Y', strtotime($patientdata->dob)) : 'N/A'}}</span>
									</div>
								</div>
							</div>
							<div class="col-lg-12">
