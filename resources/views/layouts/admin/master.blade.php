...
<!--begin::Main-->
      ...
      <div class="d-flex flex-row flex-column-fluid page">
        ...
        <div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
          ...
          <div id="kt_header" class="header flex-column header-fixed">
            <x-admins.Header></x-admins.Header>
          </div>
          <!--end::Header-->
          <!--begin::Content-->
          <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
            <div class="subheader py-2 py-lg-6 subheader-transparent {{Request::routeIs('admin.dashboard') ? 'd-none': ''}}" id="kt_subheader">
              <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                  <!--begin::Info-->
                  <div class="d-flex align-items-center flex-wrap mr-1">
                      <button class="burger-icon burger-icon-left mr-4  d-lg-none {{ Request::routeIs('admin.editprofile') || Request::routeIs('admin.changepass') ? 'd-inline-block': 'd-none'}}" id="kt_subheader_mobile_toggle">
                        <span></span>
                      </button>
                      <!--begin::Page Heading-->
    ...
    <!--end::Main-->
    <!-- begin::User Panel-->
    <x-admins.admin-quick-profile-menu></x-admins.admin-quick-profile-menu>
    <!-- end::User Panel-->
    <!--begin::Scrolltop-->
